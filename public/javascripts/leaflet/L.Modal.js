...
(function (global, factory) {
  ...
  (global = global || self, (global.L = global.L || {}, global.L.Modal = factory(global.L)));
  ...
  L.Map.Modal = L.Handler.extend( /** @lends {L.Map.Hadler.prototype} */ {
    ...
    _show: function(options) {
      ...
      L.Util.requestAnimFrame(function () {
        var contentContainer = this$1._getContentContainer();
        L.DomEvent.on(contentContainer, 'transitionend', this$1._onTransitionEnd, this$1);
        L.DomEvent.disableClickPropagation(contentContainer);
        L.DomUtil.addClass(this$1._container, this$1.options.SHOW_CLS);

        if (!L.Browser.any3d) {
          L.Util.requestAnimFrame(this$1._onTransitionEnd, this$1);
        }
      });

      var container = this._container;

      var closeBtn = container.querySelector('.' + this.options.CLOSE_CLS);
      if (closeBtn) {
        L.DomEvent.on(closeBtn, 'click', this._onCloseClick, this);
      }

      var modal = container.querySelector('.' + this.options.MODAL_CLS);
      if (modal) {
  ...
  var Modal = L.Map.Modal;

  return Modal;

})));
//# sourceMappingURL=L.Modal.js.map
